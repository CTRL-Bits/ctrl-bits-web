...
function useMousePositionRef(
  ...
  useEffect(() => {
    ...
    // Start with cursor in middle of container to avoid "jump" on first interaction
    if (containerRef.current) {
      const rect = containerRef.current.getBoundingClientRect();
...
interface VariableProximityProps extends HTMLAttributes<HTMLHeadingElement> {
  label: string;
...
>((props, ref) => {
  ...
  }, [fromFontVariationSettings, mounted]);
  ...
  // Style addition to ensure font is available
  const fontFamilyStyle = {
    fontFamily:
      '"Playfair Display", "Inter var", system-ui, -apple-system, BlinkMacSystemFont, sans-serif',
