...
const DEFAULT_GLOW_COLOR = "0, 125, 255";
...
const cardData: BentoCardProps[] = [
  {
    ...
    description: "Built fast. Delivered faster.",
    label: "Speed",
  },
  {
    color: "#000010",
    title: "Edits?",
    description: "Until it’s perfect.",
    label: "Unlimited Revisions",
  },
  {
    color: "#000010",
    title: "20+ Projects Launched",
    description: "Trusted. Fast. Creative.",
    label: "Experience",
  },
  {
    color: "#000010",
...
const ParticleCard: React.FC<{
  ...
  return (
    <div
      ref={cardRef}
      className={`${className} cursor-target relative overflow-hidden`}
